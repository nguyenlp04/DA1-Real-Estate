                                    ...
                                    <div class="qodef-grid-inner">
                                        ...
                                        <div class="qodef-grid-item qodef-page-sidebar-section qodef-col--sidebar">
                                            ...
                                            <section class="qodef-m-author">
                                                <div class="qodef-m-author-top">
                                                    ...
                                                    <div class="qodef-m-author-heading">
                                                        ...
                                                        <h4 class="qodef-m-author-heading-name">
                                                            <?php echo $result['full_name'] ?></h4> <span class="qodef-m-author-heading-address">
                                                ...
                                                <a class="qodef-shortcode qodef-m qodef-m-author-link qodef-button qodef-layout--filled qodef-size--normal-full qodef-html--link" href="<?php echo isset($_SESSION['user_info']) ? "payment?id=" . urlencode($propertyId) : 'login'; ?>"
 target="_self"> <span class="qodef-m-text" nam="submitDeposit">Giao Dịch</span></a>
                                            </section>
                                            <section class="qodef-m-mortgage-calculator">
                                                <div class="re__scam-deposit-warning-box">
                                                    <div class="box-content d-flex">
                                                        <div class="left-icon"><i class="fa-solid fa-bell text-danger fs-3 text me-2"></i></div>
                                                        <div class="warning-content">
                                                            <p class="text m-xl-0">Không nên đặt cọc, giao dịch trước khi xem nhà và xác minh thông tin của người cho thuê.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </section>
                                                                ...
                                                                <div class="qodef-m-action qodef-property-spinner">
                                                                    <button type="submit" name="submitScheduletour" class="qodef-shortcode qodef-m  qodef-button qodef-layout--filled qodef-size--normal-full ">
                                                                        <span class="qodef-btn-text">Đặt Lịch Tham
                                                                            Quan</span></button><span class="qodef-m-spinner">
