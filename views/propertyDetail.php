                    ...
                    <div class="header-meta">
                        ...
                        <div class="group-login align-items-center dropdown <?php echo $hiddenUser ?>">
                            <a class=" dropdown-toggle d-flex align-items-center hidden-arrow" href="#"
                                id="navbarDropdownMenuAvatar" type="button" data-toggle="dropdown" aria-expanded="false"
                                aria-haspopup="true">
                                <img src="./assets/images/imguser/user.png" class="rounded-circle" style="height: 35px"
                                                        ...
                                                        <div class="qodef-m-heading-top">
                                                            <div class="qodef-m-types ">
                                                                <a href="https://newhome.qodeinteractive.com/property-type/for-rent/"
                                                                    rel="tag"><?php echo $result['type'] ?></a>
                                                            </div>
                                                        </div>
                                                        <h2 class="qodef-m-heading-title"><?php echo $result['title'] ?>
                                                        </h2>
                                                        <div class="qodef-m-heading-bottom">
                                                            ...
                                                            <div class="qodef-m-property-id">
                                                                ...
                                                                <input type="hidden" name="property_id"
                                                                    value="<?php echo $result['property_id'] ?>">
                                                            </div>
                                                        ...
                                                        <div class="qodef-m-floor-plans-content">
                                                            <div class="qodef-m-floor-plans-images">
                                                                <img width="913" height="545"
                                                                    src="./assets/images/imgproperty<?php echo $result['floor_plans'] ?>"
                                                            ...
                                                            <div class="qodef-m-location-content-inner mb-3">
                                                                ...
                                                                <div class="qodef-m-location-content-inner-right">
                                                                    <div class="qodef-m-location-map-button">
                                                                        <a href="https://www.google.com/maps/search/?api=1&#038;query=<?php echo $result['location'] ?>"
                                        ...
                                        <div class="qodef-grid-item qodef-page-sidebar-section qodef-col--sidebar">
                                            ...
                                            <section class="qodef-m-author">
                                                <div class="qodef-m-author-top">
                                                    <div class="qodef-m-author-image">
                                                        <a itemprop="author"
                                                            ...
                                                            <img src="./assets/images/imguser<?php echo $result['avatar'] ?>"
                                                                alt="f" style="width:70px; height:70px"
                                                                data-ratio="1" /> </a>
                                                    </div>
                                                    <div class="qodef-m-author-heading">
                                                        <span class="qodef-m-author-heading-agency">
                                                            <?php echo $result['roles'] ?> </span>
                                                        <h4 class="qodef-m-author-heading-name">
                                                            <?php echo $result['full_name'] ?></h4> <span
                                                ...
                                                <a class="qodef-shortcode qodef-m qodef-m-author-link qodef-button qodef-layout--filled qodef-size--normal-full qodef-html--link"
                                                    href="payment?id=<?php echo $propertyId; ?>" target="_self"> <span
                                                        class="qodef-m-text">Giao Dịch</span></a>
                                            </section>
                                                        ...
                                                        <div class="qodef-m-form-inner">
                                                            <form action="POST">
                                                                ...
                                                                <div class="qodef-m-action qodef-property-spinner">
                                                                    <button type="submit" name="submitScheduletour"
                                                                        class="qodef-shortcode qodef-m  qodef-button qodef-layout--filled qodef-size--normal-full ">
                                                                        <span class="qodef-btn-text">Đặt Lịch Tham
                                                                            Quan</span></button><span
                                            ...
                                            <section class="qodef-m-mortgage-calculator">
                                                ...
                                                <div class="qodef-m-mortgage-calculator-content">
                                                    <form method="POST" class="qodef-m-form"
                                                        id="qodef-mortgage-calculator"
                                                        ...
                                                        <div class="qodef-m-form-inner">
                                                            ...
                                                            <div class="qodef-m-form-row">
                                                                <input type="text" name="price_offered"
                                                            ...
                                                            <input type="hidden" name="agent_id" value="5" />
                                                            <div class="qodef-m-action qodef-property-spinner">
                                                                <button type="submit" name="submitNegotiations"
                                                                    class="qodef-shortcode qodef-m  qodef-button qodef-layout--filled qodef-size--normal-full ">
                                                                    <span class="qodef-btn-text">Thương
                                                                        lượng</span></button>
                                                            </div>
                                                        </div>
                                                    </form>
