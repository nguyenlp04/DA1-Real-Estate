                    ...
                    <div class="w-11/12">
                        <div>
                            <div class=" px-6 mx-auto">
                                <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl" style="
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="flex-none w-auto max-w-full px-3">
                                            <div class="text-base ease-soft-in-out h-18.5 w-18.5 relative inline-flex items-center justify-center rounded-xl text-white transition-all duration-200">
                                                <img src="./../assets/images/imguser<?php echo  $_SESSION['user_info']['avatar'] ?>" alt="profile_image" class="w-full shadow-soft-sm rounded-xl" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="ml-4 w-full max-w-full px-3 mx-auto mt-4 sm:my-auto sm:mr-0 md:w-1/2 md:flex-none lg:w-4/12">
                                            <div class="relative right-0">
                                                <ul class="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl" nav-pills role="tablist">
                                                    <li class="z-30 flex-auto text-center">
                                                        <button data-section="editInfo" class="section-button z-30 block w-full px-0 py-1 mb-0 transition-all hover:no-underline  border-0 rounded-lg  bg-inherit text-slate-700">
                                                    ...
                                                    <li class="z-30 flex-auto text-center">
                                                        <button data-section="changePassword" class="section-button z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg  bg-inherit text-slate-700">
                                    ...
                                    <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-5/12">
                                        <div class="relative flex flex-col  min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                                            <div class="p-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
                                                <div class="flex flex-wrap -mx-3">
                                                    <div class="flex items-center  max-w-full px-3 shrink-0 md:w-8/12 md:flex-none">
                                                ...
                                                <form action="" method="POST" class="mb-6">
                                                    <div class="grid md:grid-cols-2 grid-cols-1 md:gap-x-4 md:gap-y-0 gap-4">
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="current-password" class="text-black font-semibold pb-1 capitalize"> Mật
                                                                khẩu hiện tại </label>
                                                            <input type="password" id="current-password" class="p-2 border border-[#a5abb5] rounded" name="current-password">
                                                        </div>
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="new-password" class="text-black font-semibold pb-1 capitalize"> Mật
                                                                khẩu mới </label>
                                                            <input type="password" id="new-password" class="p-2 border border-[#a5abb5] rounded" name="new-password">
                                                        </div>
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="confirm-password" class="text-black font-semibold pb-1 capitalize"> Nhập
                                                                lại </label>
                                                            <input type="password" id="confirm-password" class="p-2 border border-[#a5abb5] rounded" name="confirm-password">
                                                        </div>
                                                        <div class="w-full flex justify-center items-center h-1/2 py-2">
                                                            <input type="submit" name="editpassword" class="hover:text-[#0957CB] bg-[#0957CB] text-white rounded-lg p-3 text-sm font-semibold" value="Thay đổi">
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="relative flex flex-col  min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                                            ...
                                            <div class="flex-auto pl-4 ">
                                                <form action="" class="mb-6">
                                                    <div class="grid md:grid-cols-2 grid-cols-1 md:gap-x-4 md:gap-y-0 gap-4">
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="fullname" class="text-black font-semibold pb-1 capitalize"> Tên
                                                                đầy đủ </label>
                                                            <input type="fullname" id="fullname" class="p-2 border border-[#a5abb5] rounded" name="fullname" value=" <?php echo  $_SESSION['user_info']['full_name'] ?>">
                                                        </div>
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="email" class="text-black font-semibold pb-1 capitalize"> Email
                                                            </label>
                                                            <input type="email" id="email" class="p-2 border border-[#a5abb5] rounded" name="email" value=" <?php echo  $_SESSION['user_info']['email'] ?>">
                                                        </div>
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="phonenumber" class="text-black font-semibold pb-1 capitalize"> Số
                                                                điện thoại</label>
                                                            <input type="phonenumber" id="phonenumber" class="p-2 border border-[#a5abb5] rounded" name="phonenumber" value=" <?php echo  $_SESSION['user_info']['phone_number'] ?>">
                                                        </div>
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="confirm-password" class="text-black font-semibold pb-1 capitalize"> Ngày
                                                                sinh</label>
                                                            <input type="birthuser" id="confirm-password" class="p-2 border border-[#a5abb5] rounded" name="birthuser" value=" <?php echo  $_SESSION['user_info']['birth_user'] ?>">
                                                        </div>
                                                        <div class="w-full flex flex-col py-2">
                                                            <label for="addressuser" class="text-black font-semibold pb-1 capitalize"> Địa
                                                                chỉ</label>
                                                            <input type="addressuser" id="addressuser" class="p-2 border border-[#a5abb5] rounded" name="addressuser" value=" <?php echo  $_SESSION['user_info']['address_user'] ?>">
                                                        </div>
                                                        <div class="w-full flex justify-center items-center h-1/2  mt-auto py-2">
                                                            <input type="submit" name="editinfo" class="hover:text-[#0957CB] bg-[#0957CB] text-white rounded-lg p-3 text-sm font-semibold" value="Thay đổi">
                                                        </div>
                                                    </div>
                                                </form>
                                    ...
                                    <div fixed-plugin-card class="z-sticky shadow-soft-3xl w-90 ease-soft -right-90 fixed top-0 left-auto flex h-full min-w-0 flex-col break-words rounded-none border-0 bg-white bg-clip-border px-2.5 duration-200">
                                        ...
                                        <div class="flex-auto p-6 pt-0 sm:pt-4">
                                            ...
                                            <div class="w-full text-center">
                                                ...
                                                <a href="https://twitter.com/intent/tweet?text=Check%20Soft%20UI%20Dashboard%20Tailwind%20made%20by%20%40CreativeTim&hashtags=webdesign,dashboard,tailwindcss&amp;url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fsoft-ui-dashboard-tailwind" class="inline-block px-6 py-3 mb-0 mr-2 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer hover:shadow-soft-xs hover:scale-102 active:opacity-85 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 me-2 border-slate-700 bg-slate-700" target="_blank">
