                ...
                <div class="w-full flex justify-center h-auto">
                    <div class="w-11/12">
                        ...
                        <div class="title-container flex items-center">
                            <h1 class="text-[#0957CB] font-semibold text-md py-4 h3">Chỉnh Sửa Bất Động Sản</h1>
                            ...
                            <div class="w-full flex flex-col lg:flex-row gap-4">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="flex flex-col md:flex-row gap-4">
                                        ...
                                        <div class="w-full flex flex-col py-2">
                                            ...
                                            <input type="number" name="property_area" id="property_area"
                                                class="p-2  border border-[#E8F0FC] rounded"
                                                value="<?php echo $property['acreage']?>">
                                        </div>
                                    </div>
                                    <div class="flex flex-col md:flex-row gap-4">
                                        <div class="w-full flex flex-col py-2">
                                        ...
                                        <div class="w-full flex flex-col py-2">
                                            ...
                                            <input type="number" name="property_year" id="property_year"
                                                class="p-2  border border-[#E8F0FC] rounded"
                                                value="<?php echo $property['built_in']?>">
                                        </div>
                                    ...
                                    <div class="flex flex-col md:flex-row gap-4">
                                        <div class="w-full flex flex-col py-2">
                                            <label for="property_conditioner"
                                                ...
                                                hòa</label>
                                            <input type="number" name="property_conditioner" id="property_conditioner"
                                                class="p-2  border border-[#E8F0FC] rounded"
                                                value="<?php echo $property['conditioner']?>">
                                        </div>
                                        <div class="w-full flex flex-col py-2">
                                    ...
                                    <div class="flex flex-col md:flex-row gap-4">
                                        <div class="w-full flex flex-col py-2">
                                            ...
                                            <select name="property_tags" id="property_tags"
                                                ...
                                                foreach ($result as $row) {
                                                    $selected = ($row['tag_name'] == $property['tag_name']) ? 'selected' : '';
                                        ...
                                        <div class="w-full flex flex-col py-2">
                                            <label for="property_cam"
                                                class="text-black  font-semibold pb-1 capitalize">Cameras</label>
                                            <input type="number" name="property_cam" id="property_cam"
                                                class="p-2  border border-[#E8F0FC] rounded"
                                                value="<?php echo $property['cameras']?>">
                                        </div>
                                    </div>

                                    <div class="flex flex-col md:flex-row gap-4">
                                        <div class="w-full flex flex-col py-2">
                                            <label for="city" class="text-black  font-semibold pb-1 capitalize">Thành
                                                phố</label>
                                    ...
                                    <div class="w-full flex flex-col py-2">
                                        <label for="" class="text-black flex font-semibold pb-1 capitalize">Vị trí trên
                                            bản đồ &nbsp;
                                    ...
                                    <div class="w-full flex flex-col py-2 mt-10">
                                        <div class="text-black pb-3 capitalize inline-block"> <i
                                                class="fa-solid fa-file-image fa-2xl"></i> Tải lên ảnh sơ đồ mặt bảng
                                        </div>
                                        <input type="file" class="article_photo" name="floorPlanImage"
                                            id="floorPlanImage" class="p-2 hidden border border-[#E8F0FC] rounded"
                                    ...
                                    <div class="w-full flex flex-col py-2 mt-10">
                                        <div class="text-black pb-3 capitalize inline-block"> <i
                                                class="fa-solid fa-file-image fa-2xl"></i> Tải lên ảnh bất động sản
                                        </div>
                                        <input type="file" class="article_photo" name="propertyImage[]"
                                            id="propertyImage" class="p-2  hidden border border-[#E8F0FC] rounded"
                                    ...
                                    <div class="flex flex-col md:flex-row gap-4">
                                        <div class="w-full flex flex-col py-2">
                                            ...
                                            <textarea name="description" id="description" rows="4"
                                                class="p-2  border border-[#E8F0FC] rounded">  <?php echo $property['description']?></textarea>
                                        </div>
                                    </div>
