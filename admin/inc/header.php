            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Bất động sản</a>
                        <a class="collapse-item" href="">Thêm bất động sản</a>
                        <a class="collapse-item" href="">Thêm tags</a>
                        <a class="collapse-item" href="">Bất động sản chờ duyệt</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseTransaction" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=""> Hợp đồng </a>
                        <a class="collapse-item" href="">Thương lượng</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseuser" class="collapse" aria-labelledby="headinguser" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Tất cả người dùng</a>
                        <a class="collapse-item" href="">Thêm người dùng </a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="facebook.com"><i class="fas fa-fw fa-wrench"></i> <span>Cài đặt</span></a>
            </li>
