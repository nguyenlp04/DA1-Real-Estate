                    ...
                    <div class="advance-search">
                        <form action="#" class="inline-form">
                            ...
                            <div class="input-group">
                                ...
                                <input name="city" id="city" type="text" placeholder="Đà Nẵng" class="myInput"
                                ...
                                <div class="icon">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M6.75 16.5V9H11.25V16.5" stroke="currentColor" stroke-linecap="round"
                            ...
                            <div class="input-group">
                                ...
                                <div class="icon">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 0.75V17.25" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                        ...
                        <div class="house-card">
                            ...
                            <div class="house__content">
                                ...
                                <div class="house__content__main">
                                    ...
                                    <p class="location">
                                        <span class="icon"><img src="assets/images/icons/map-pin.svg"
                                                alt="map pin" /></span>
                            ...
                            <div class="house__content__bottom">
                                <div class="info-wrap">
                                    ...
                                    <div class="info">
                                        <div class="icon">
                                            <img src="assets/images/icons/bathtub.png" alt="bathtub" />
                                        </div>
                                        <span>2</span>
                                    </div>
                                    <div class="info">
                                        <div class="icon">
                                            <img src="assets/images/icons/garage-car.png" alt="garage-car" />
                                        </div>
                                        <span>3</span>
                                    </div>
                                    <div class="info info-right">
                                        <div class="icon">
                                            <img src="assets/images/icons/square-target.png" alt="square-target" />
                                        </div>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-5">
                    <div class="section-header__content v2">
                        ...
                        <a href="./introduce.html" class="btn btn-primary">Đọc Thêm</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="slider-nav">
                        <button type="button" class="prev">
                            ...
                            <svg width="31" height="25" viewBox="0 0 31 25" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M26 12.5H5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M12 19.5L5 12.5L12 5.5" stroke="currentColor" stroke-width="2"
                        ...
                        <button type="button" class="next">
                            ...
                            <svg width="43" height="25" viewBox="0 0 43 25" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 12.5L38 12.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M31 5.5L38 12.5L31 19.5" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapse01" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-heading05">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="flush-collapse05">
                                            05. Bạn làm nghề gì?
                                        </button>
                                    </h2>
                                    <div id="flush-collapse05" class="accordion-collapse collapse"
                                        aria-labelledby="flush-heading05" data-bs-parent="#accordionFlushExample01">
                                        <div class="accordion-body">
                                            <p>
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde aliquam
                                                amet distinctio, impedit sequi laboriosam esse magni
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-heading06">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="flush-collapse06">
                                            06. Bạn làm nghề gì?
                                        </button>
                                    </h2>
                                    <div id="flush-collapse06" class="accordion-collapse collapse"
                                        aria-labelledby="flush-heading06" data-bs-parent="#accordionFlushExample01">
                                        <div class="accordion-body">
                                            <p>
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde aliquam
                                                amet distinctio, impedit sequi laboriosam esse magni
